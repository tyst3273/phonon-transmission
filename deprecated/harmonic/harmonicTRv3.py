...
# -*- coding: utf-8 -*-
"""
Got rid of the DoS part to save time, has the scipy dot product for speed
...
win = 0.001 #gaussian smoothing width = THz
...
## CLEAN UP VARIABLES ##    
del idsL, idsR, idsfij, tmp, vels, velsfile
