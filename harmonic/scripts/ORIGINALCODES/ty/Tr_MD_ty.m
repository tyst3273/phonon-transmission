@clear
CS='membrane'; % the prefix of file names 
dT=60 % temperature difference used in NEMD simulations
...
%     data_vL=data_v(1:870,:);
%     data_vR=data_v(871:1740,:);
%     
